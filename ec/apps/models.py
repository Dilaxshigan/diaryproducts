...
class Product(models.Model):
    ...
    category = models.CharField(choices = CATEGORY_CHOICES, max_length = 2) #act as dropdown menu
...
class Payment(models.Model):
    ...
    payhere_payment_status = models.CharField(max_length = 100, blank=True, null= True)
